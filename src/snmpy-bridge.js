...
class SnmpyBridge {
  ...
  estimateTonerLevels(tonerList, data) {
    ...
    const yields = SnmpyBridge.TONER_YIELDS;
...
// OEM cartridge yields (pages @5% ISO/IEC 19798) — shared with PollerService estimator
SnmpyBridge.TONER_YIELDS = {
  'ricoh': { black: 12000, color: 6000 },
  'ricoh:im c2010': { black: 12000, color: 6000 },
  'ricoh:im c3010': { black: 15000, color: 8000 },
  'ricoh:im c3510': { black: 20000, color: 10000 },
  'ricoh:im c4510': { black: 20000, color: 10000 },
  'ricoh:im c5510': { black: 30000, color: 15000 },
  'ricoh:im c6010': { black: 30000, color: 15000 },
  'ricoh:sp 325sfnw': { black: 12000, color: 0 },
  ...
  'hp:pagewide': { black: 10000, color: 8000 },
  'hp:pagewide pro 552': { black: 10000, color: 8000 },
  ...
  'hp:laserjet m454': { black: 2600, color: 2600 },
  ...
  'epson:ecotank': { black: 8000, color: 6000 },
  ...
  'xerox:apeosport': { black: 26000, color: 15000 },
